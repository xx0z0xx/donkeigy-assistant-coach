...
public class AssistantCoach
{
    ...
    {
        new MainForm("Assistant Coach DEMO");
    }
    public static void mainTest( String[] args )
    {
        ...
        try
        {
            ...
            if(oAuthConn.retrieveAccessToken(verifier))
            {
                ...
                java.util.List<Team> teamList = teamService.getLeagueTeams(testLeauge.getLeague_key());
                ...
                java.util.List<LeagueTransaction> transactions = gameService.getLeagueTransactions(testLeauge.getLeague_key());
